<script lang="ts">
	import type { ELV8RegistrationData } from '$lib/types/attendance';
	import FormField from './FormField.svelte';

	interface Props {
		formData: ELV8RegistrationData;
		isSubmitting: boolean;
		onSubmit: () => void;
		onUpdate: (data: Partial<ELV8RegistrationData>) => void;
	}
...
<div class="glass rounded-2xl shadow-brand-lg p-8 animate-slide-in-up">
	...
	<form onsubmit={handleSubmit} class="space-y-6">
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
			<FormField id="elv8_first_name" label="First Name" required>
				<input
					type="text"
					id="elv8_first_name"
			...
			<FormField id="elv8_last_name" label="Last Name" required>
				<input
					type="text"
					id="elv8_last_name"
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
			<FormField id="elv8_birth_month" label="Birth Month" required>
				<select
					id="elv8_birth_month"
			...
			<FormField id="elv8_birth_year" label="Birth Year" required>
				<select
					id="elv8_birth_year"
		...
		<FormField id="elv8_gender" label="Gender" required>
			<select
				id="elv8_gender"
		...
		<FormField id="elv8_social_media_name" label="Socials" helpText="Optional">
			<input
				type="text"
				id="elv8_social_media_name"
